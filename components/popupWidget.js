                        ...
                        <Transition
                            ...
                            <Disclosure.Panel className=' flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]'>
                                ...
                                <div className='flex-grow h-full p-6 overflow-auto bg-gray-50 '>
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)} noValidate>
                                            ...
                                            <div className='mb-4'>
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                                                        errors.name ? 'border-red-600 focus:border-red-600 ring-red-100' : 'border-gray-300 focus:border-indigo-600 ring-indigo-100'
                                                    }`}
                                                />
                                                {errors.name && <div className='mt-1 text-sm text-red-400 invalid-feedback'>{errors.name.message}</div>}
                                            </div>
                                            ...
                                            <div className='mb-4'>
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full px-3 py-2 text-gray-600 placeholder-gray-300 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring   ${
                                                        errors.email ? 'border-red-600 focus:border-red-600 ring-red-100' : 'border-gray-300 focus:border-indigo-600 ring-indigo-100'
                                                    }`}
                                                />

                                                {errors.email && <div className='mt-1 text-sm text-red-400 invalid-feedback'>{errors.email.message}</div>}
                                            </div>
                                    ...
                                    {isSubmitSuccessful && isSuccess && (
                                        <>
                                            <div className='flex flex-col items-center justify-center h-full text-center text-white rounded-md'>
                                                <svg width='60' height='60' className='text-green-300' viewBox='0 0 100 100' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                                    <path
                                                ...
                                                <button className='mt-6 text-indigo-600 focus:outline-none' onClick={() => reset()}>
                                                    Go back
                                                </button>
                                            </div>
                                        </>
                                    ...
                                    {isSubmitSuccessful && !isSuccess && (
                                        <div className='flex flex-col items-center justify-center h-full text-center text-white rounded-md'>
                                            <svg width='60' height='60' viewBox='0 0 97 97' className='text-red-400' fill='none' xmlns='http://www.w3.org/2000/svg'>
                                                <path
                                            ...
                                            <h3 className='text-xl text-red-400 py-7'>Oops, Something went wrong!</h3>
                                            <p className='text-gray-700 md:px-3'>{Message}</p>
                                            <button className='mt-6 text-indigo-600 focus:outline-none' onClick={() => reset()}>
                                                Go back
                                            </button>
